...
ORCA_USE_WORLD_STATE=${ORCA_USE_WORLD_STATE:-auto}
...
if [ "${ORCA_USE_WORLD_STATE}" = "auto" ]; then
  if [ "${USE_SPAWNED_FORMATION}" = "1" ]; then
    ORCA_USE_WORLD_STATE=1
  else
    ORCA_USE_WORLD_STATE=0
  fi
fi
...
FORMATION_ESTIMATOR=${FORMATION_ESTIMATOR:-consensus}
CONSENSUS_TOPOLOGY=${CONSENSUS_TOPOLOGY:-chain}
CONSENSUS_ALPHA=${CONSENSUS_ALPHA:-0.18}
CONSENSUS_BETA=${CONSENSUS_BETA:-0.35}
CONSENSUS_CORRECTION_GAIN=${CONSENSUS_CORRECTION_GAIN:-0.35}
CONSENSUS_CORRECTION_LIMIT=${CONSENSUS_CORRECTION_LIMIT:-0.45}
REAR_SAFETY_ENABLE=${REAR_SAFETY_ENABLE:-1}
REAR_SAFE_DIST=${REAR_SAFE_DIST:-1.35}
VIRTUAL_LAG_PAUSE_LIMIT=${VIRTUAL_LAG_PAUSE_LIMIT:-2.1}
VIRTUAL_LAG_RESUME_LIMIT=${VIRTUAL_LAG_RESUME_LIMIT:-1.5}
...
export FORMATION_ESTIMATOR
export CONSENSUS_TOPOLOGY
export CONSENSUS_ALPHA
export CONSENSUS_BETA
export CONSENSUS_CORRECTION_GAIN
export CONSENSUS_CORRECTION_LIMIT
export REAR_SAFETY_ENABLE
export REAR_SAFE_DIST
export VIRTUAL_LAG_PAUSE_LIMIT
export VIRTUAL_LAG_RESUME_LIMIT
...
echo "[MODE] FORMATION_ESTIMATOR=${FORMATION_ESTIMATOR}, CONSENSUS_TOPOLOGY=${CONSENSUS_TOPOLOGY}, CONSENSUS_CORRECTION_LIMIT=${CONSENSUS_CORRECTION_LIMIT}, REAR_SAFE_DIST=${REAR_SAFE_DIST}"
echo "[MODE] VIRTUAL_LAG_PAUSE_LIMIT=${VIRTUAL_LAG_PAUSE_LIMIT}, VIRTUAL_LAG_RESUME_LIMIT=${VIRTUAL_LAG_RESUME_LIMIT}"
...
echo "[MODE] ORCA_USE_WORLD_STATE=${ORCA_USE_WORLD_STATE}"
